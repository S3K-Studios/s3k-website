                ...
                <div className="flex flex-col min-h-screen">
                  ...
                  <main className="flex-grow">
                    <Switch>
                      ...
                      <Route component={PrivacyPolicyPage} path="/atomicboom/privacy" />
                      <Route component={TermsOfServicePage} path="/atomicboom/terms" />
                      <Route component={DataDeletionPage} path="/atomicboom/data-deletion" />
                    </Switch>
